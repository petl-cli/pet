...
const (
	feedbackEndpoint = "http://localhost:8787/v1/feedback"
	feedbackToken    = "ea4eb151-9d6e-4a11-a561-d56233ef1d9e"
)
...
Examples:
  petstore feedback "the --filter regex syntax is unclear"
  petstore feedback --about "create-widget" "exit code 0 but no output"
`,
