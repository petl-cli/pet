...
import (
	...
	"github.com/example/petstore/internal/telemetry"
...
var _configDir = func() string {
	...
	return filepath.Join(home, ".config", "petstore")
}()
...
var rootCmd = &cobra.Command{
	Use:           "petstore",
	Short:         "A sample API for managing pets",
	Version:       "0.1.0",
...
var _configLoader = &config.Loader{
	...
	DefaultURL:   "http://petstore.swagger.io/v1",
}
